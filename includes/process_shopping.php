...
function checkout($full_name, $phone_number, $delivery_date, $address_1, $address_2, $city, $province, $country) { 
	...
	$message .= 'Click here to view order Details.<a href="https://destingrocerygirls.com/wp-admin/admin.php?page=list_orders&order_id='.$order_id.'">Check Order Details</a>';
